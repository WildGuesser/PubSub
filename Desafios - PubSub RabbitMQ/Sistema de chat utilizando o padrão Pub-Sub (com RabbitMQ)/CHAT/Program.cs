...
namespace CHAT
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Set the routing key
            var routingKey = "info"; // Replace with your desired routing key

            // Faz o binding da fila ao exchange associado ao tópico e routingkey
            ...
            while (true)
            {
                ...
                // Publica a mensagem no exchange associado ao tópico
